...
<header>
    ...
    <input type="text" class="form-control" id="inputEmail4" name = "userName">
  	...
  	<div class="col-md-4">
    <label for="inputEmail4" class="form-label">Enter your DOB</label>
    <input type="date" class="form-control" id="inputEmail4" name = "dateofbirth">
  	</div><br>
	...
	<div class="col-md-5">
    <label for="inputEmail4" class="form-label">Select your Gender</label>
  	</div>
	...
	<label for="inputEmail4" class="form-label">Select Languages</label>
	<div class="col-md-1">
